...
$router->match(['get', 'post'], 'demo/app_export', 'AppExportController@index');
$router->match(['get', 'post'], 'demo/app_export/export', 'AppExportController@export');
...
$router->match(['get', 'post'], 'demo/app_test_other', 'AppTestOtherController@index');